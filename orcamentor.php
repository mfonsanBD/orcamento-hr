...
if(isset($_POST['recaptcha']) && !empty($_POST['recaptcha'])){
	...
	if ($resposta->success) {
		...
		try {
			...
			$assunto 		= 'Pedido de Orçamento para Residência';

			$mail->setFrom($email, utf8_decode($nome));
			$mail->addAddress('comercial@grupohrbrasil.com.br', 'Grupo HR');
			...
			<div style='width: 560px; padding: 30px 20px; font-size:14px; background-color: #ededed; font-family: helvetica;'>
				...
				<p style='color: #666; margin-bottom: 5px;'>Como é a sua Residência?</p><b style='color: #000 !important;'>".$p1."</b>

				<p style='color: #666; margin-bottom: 5px;'>Esta é a sua Residência Habitual ou Segunda Residência?</p><b style='color: #000 !important;'>".$p2."</b>

				<p style='color: #666; margin-bottom: 5px;'>Qual é a localização da Residência?</p><b style='color: #000 !important;'>".$p3."</b>

				<p style='color: #666; margin-bottom: 5px;'>Como é o acesso principal da Residência?</p><b style='color: #000 !important;'>".$p4."</b>

				<p style='color: #666; margin-bottom: 5px;'>A sua Residência possui Acessos Secundários?</p><b style='color: #000 !important;'>".$p5."</b>

				<p style='color: #666; margin-bottom: 5px;'>As janelas da sua Residência têm grades?</p><b style='color: #000 !important;'>".$p6."</b>

				<p style='color: #666; margin-bottom: 5px;'>Quanto tempo a casa permanece desabitada?</p><b style='color: #000 !important;'>".$p7."</b>

				<p style='color: #666; margin-bottom: 5px;'>A sua residência ou a dos seus vizinhos foi roubada anteriormente?<br><b style='color: #000 !important;'>".$p8."</b></p><br>
