...
if(isset($_POST['recaptcha']) && !empty($_POST['recaptcha'])){
	...
	if ($resposta->success) {
		...
		$mail->Subject  = "Pedido de Orçamento para Residência"; // Assunto da mensagem
		$mail->Body = "
		...
		<div style='width: 600px; padding: 30px 20px; font-size:14px; background-color: #ededed; font-family: helvetica;'>
			...
			<p style='color: #666; margin-bottom: 5px;'>Como é a sua Residência? <b style='color: #000 !important;'>".$p1."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>Esta é a sua Residência Habitual ou Segunda Residência? <b style='color: #000 !important;'>".$p2."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>Qual é a localização da Residência? <b style='color: #000 !important;'>".$p3."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>Como é o acesso principal da Residência? <b style='color: #000 !important;'>".$p4."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>A sua Residência possui Acessos Secundários? <b style='color: #000 !important;'>".$p5."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>As janelas da sua Residência têm grades? <b style='color: #000 !important;'>".$p6."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>Quanto tempo a casa permanece desabitada? <b style='color: #000 !important;'>".$p7."</b></p>

			<p style='color: #666; margin-bottom: 5px;'>A sua residência ou a dos seus vizinhos foi roubada anteriormente? <b style='color: #000 !important;'>".$p8."</b></p><br><br>
