...
require_once("phpmailer/PHPMailerAutoload.php");
 ...
 $mail->Host = "smtp.grupohrbrasil.com.br"; // Seu endereço de host SMTP
 $mail->SMTPAuth = true; // Define que será utilizada a autenticação -  Mantenha o valor "true"
 $mail->Port = 587; // Porta de comunicação SMTP - Mantenha o valor "587"
 $mail->SMTPSecure = false; // Define se é utilizado SSL/TLS - Mantenha o valor "false"
 $mail->SMTPAutoTLS = false; // Define se, por padrão, será utilizado TLS - Mantenha o valor "false"
 $mail->Username = 'orcamento@grupohrbrasil.com.br'; // Conta de email existente e ativa em seu domínio
 $mail->Password = 'GrupoHR2020'; // Senha da sua conta de email
